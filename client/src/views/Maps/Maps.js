  ...
  lifecycle({
    componentDidMount() {
      ...
      DirectionsService.route(
        {
          origin: new google.maps.LatLng(16.8524, 74.5815),
          destination: new google.maps.LatLng(16.8524, 74.5815),
    ...
    componentWillMount() {
      ...
      this.setState({
        bounds: null,
        source: { lat: 16.8524, lng: 74.5815 },
        destination: { lat: 16.8524, lng: 74.5815 },
        center: {
          lat: 41.9, lng: -87.624
        },
        markers: [],
        ...
        getRoute: (source, destination) => {
          ...
          DirectionsService.route(
            ...
            (result, status) => {
              ...
              // Calculating distance between soucre and destination and storing in dis             
